...
?>
        <!-- Owl Carousel v2.2.0 --> 
                ...
                for ($i=1; $i<=5; $i++) {
                   ...
                   if (esc_html(get_theme_mod('sagablog_choose_main_slider_header_post_' .$i )) && esc_html(get_theme_mod('sagablog_choose_main_slider_header_post_' .$i ))!== 0) {
                   $postid=(int)esc_html(get_theme_mod('sagablog_choose_main_slider_header_post_' .$i ));
